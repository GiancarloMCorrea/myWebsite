...
# Case 2 ------------------------------------------------------------------
sheet1 = readxl::read_xlsx(path = 'case2.xlsx', sheet = 1)
sheet2 = readxl::read_xlsx(path = 'case2.xlsx', sheet = 2)
sheet3 = readxl::read_xlsx(path = 'case2.xlsx', sheet = 3)
sheet4 = readxl::read_xlsx(path = 'case2.xlsx', sheet = 4)
sheet5 = readxl::read_xlsx(path = 'case2.xlsx', sheet = 5)
...
input2 = wham::prepare_wham_input(model_name = "Case_2",
...
# Make plots:
plot_wham_output(model2, out.type = 'pdf')
