...
La talla media a cualquier fracción del año se calcula como:
...
Especificamos tanto `growth` como `LAA`. Del argumento `LAA` solo se tomará información de `re`, lo demás no es necesario. 
