...
- `"dirichlet-pool0"`: Se agregan valores ceros para edades viejas [@Francis_2014]. 1 parámetro.
- `"dirichlet-miss0"`: Trata los ceros como valores faltantes. 1 parámetro.
...
- `"logistic-normal-pool0"`: Logistic normal, se agregan valores ceros para edades viejas. 1 parámetros.
