...
donde $-1<\rho_a <1$ y $-1<\rho_y <1$ son los coeficientes de autocorrelación.
...
* `N1_pars`: (*vector*) valores iniciales para la abundancia a la edad inicial. Puede ser un vector con longitud igual al número de edades (si `N1_model = 0`), o un vector con dos valores (si `N1_model = 1`).
...
* `cor`: (caracter) estructura de efectos aleatorios
