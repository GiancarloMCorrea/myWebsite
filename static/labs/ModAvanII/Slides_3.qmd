...
* `initial_means`: (vector) valores iniciales de $M$. Va a depender del `model` que hayamos elegido.

::: fragment

* `est_ages`: (vector) edades a estimar $M$. Si `model` es `constant`, entonces es 1.
