...
* `initial_means`: (vector) valores iniciales de $M$. Longitud va a depender del `model` que hayamos elegido. Para `constant` y `weight-at-age`, será solo un valor ($log_b$ es asumido ser 0.305). 
