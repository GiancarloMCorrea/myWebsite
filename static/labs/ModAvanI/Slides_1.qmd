...
::: {.column width="40%"}
Uso de métodos de observación directa, como campañas acústivas, de arrastre, ictioplancton, entre otros.
:::
...
- Facilidad de investigar el impacto de diferentes fuentes de datos sobre resultados
