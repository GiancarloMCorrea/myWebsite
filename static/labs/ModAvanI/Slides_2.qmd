...
Existen diferentes formas de hacerlo. Para este curso, usaremos la libería *r4ss* y el modelo de ejemplo que pueden encontrar en [SS Virtual Lab](https://github.com/nmfs-ost/ss3-user-examples/tree/main).
