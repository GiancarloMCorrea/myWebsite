...
Para mayor información sobre el uso de la librería para crear gráficos de modelos lineales, ver [aquí](https://www.sscc.wisc.edu/sscc/pubs/Rmisc/margins.html#setup).
...
```{r, out.width=500, fig.align="center", warning=FALSE,message=FALSE}
