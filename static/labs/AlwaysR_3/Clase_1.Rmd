...
Revisar silabo en [Cousteau Consultant Group](https://cousteau-group.com/cursos/).
...
* ***Material***: Presentaciones, códigos y videos en Google Drive. También puede ser encontrado en mi [sitio web](https://giancarlomcorrea.netlify.app/es/courses/).

--

* ***Certificado***: De asistencia ó aprobación (cumplir con un proyecto final).

--

* ***Horas de oficina***: Miércoles 11 de agosto a las 18:00 horas (GMT-5)

--

* ***Contacto***: Escribir a [*cursos@cousteau-group.com*](mailto:cursos@cousteau-group.com)
...
En *R* podemos usar (cuartiles y percentiles):
