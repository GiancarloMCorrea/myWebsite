...
Basado en el $p-value$, las variables de filas y columnas **no** son independientes entre ellas, por lo tanto están estadísticamente asociadas.
...
* Muestra 2: $X_{21}, ..., X_{2n_2}$ de la población 1 con media $\mu_2$ y varianza $\sigma_2^2$.

* Muestra n: $X_{m1}, ..., X_{mn_m}$ de la población 1 con media $\mu_m$ y varianza $\sigma_m^2$.
