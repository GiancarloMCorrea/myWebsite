...
Supongamos que realizo un muestreo de una población y capturé 20 individuos ( $n=30$ ). El evento de interés es que un individuo sea macho ( $p = P(macho)$ ). Tenemos que $H_0: p=0.5$ y $H_A: p>0.5$. Entonces:
