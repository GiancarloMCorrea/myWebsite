...
```{r, out.width=350, fig.align="center", echo = FALSE,message=FALSE, warning=FALSE}
...
```{r echo = FALSE, out.width=600, fig.align="center"}
knitr::include_graphics("images/standarderror.jpg")
```
...
- $H_A$: al menos uno de $\beta_1$ o $\beta_2$ o $\beta_3$ no es cero.
...
Usando `plot_model` de la librería `sjPlot`:
