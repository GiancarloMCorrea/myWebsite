...
Prepare the data object for WHAM (this will be a function in the future):
...
wham_data$weight_model = 2 # use LW
...
my_input5$data$weight_model = 2 # use observed WAA
my_input5$data$waa_cv[1:2,,] = 0.1
my_input5$data$use_catch_waa[,1] = 1
my_input5$data$use_index_waa[,1] = 1
```
