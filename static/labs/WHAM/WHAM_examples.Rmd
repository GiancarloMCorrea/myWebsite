...
```{r echo = FALSE, fig.cap="Selectivity-at-length", out.width='100%'}
knitr::include_graphics("growth_models/compare_png/compare_SSB_F_R.png")
```
...
```{r echo = FALSE, fig.cap="Compare mean length-at-age", out.width='100%'}
knitr::include_graphics("LAA_comparison.png")
```
...
```{r echo = FALSE, fig.cap="Selectivity-at-length", out.width='100%'}
knitr::include_graphics("my_model_4/plots_png/results/selex_tile.png")
```
...
```{r echo = FALSE, fig.cap="Trends in the a parameter between models", out.width='100%'}
knitr::include_graphics("par_a_comparison.png")
```
