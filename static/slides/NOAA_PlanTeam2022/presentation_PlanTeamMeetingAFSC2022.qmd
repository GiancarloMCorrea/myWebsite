...
Allows to incorporate both observation and process errors.
...
- $N_y \sim f(N_{y-1}, F_{y-1}, M_{y-1}, \epsilon)$
...
::: incremental
- random effects use and meaning
- length information cannot be incorporated
- growth modeling not available
- no applications in the US West Coast or Alaska region
:::
...
For this case, mean length-at-age ( $\tilde{L}_{y,a}$ ) are assumed to be parameters and can be estimated. $\sigma_a$ still needed.
