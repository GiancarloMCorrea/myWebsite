...
Evaluate the impacts of temporal and time-area closures on the future (ten-years projection) status of tropical tunas in the Indian Ocean (IO).

- Status evaluated using $SB/SB_{msy}$ and $F/F_{msy}$ in the terminal year of the projection period.
