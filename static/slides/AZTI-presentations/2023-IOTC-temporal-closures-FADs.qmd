...
-   Closing the PS-FAD fishery produced the largest positive impact on the stock status compared to other fleet-specific closures, followed by BB (for BET) and GI and HD (for YFT).
:::
