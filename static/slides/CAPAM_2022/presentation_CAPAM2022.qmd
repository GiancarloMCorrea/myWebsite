...
-   Selectivity and M-at-age
-   Some Qs vary over time
...
# Thanks for listening {background-color="white"}

![](images/University_of_Washington.png){.absolute top="200" left="40" height="90px"}

![](images/NOAA_FISHERIES_logoH.png){.absolute top="175" left="540" height="160px"}
