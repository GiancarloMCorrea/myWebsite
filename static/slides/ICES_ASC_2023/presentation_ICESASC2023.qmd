...
institute:
   <br>$^1$AZTI, Marine Research, Sukarrieta, Spain. $^2$School of Aquatic and Fishery Sciences, University of Washington, Seattle, WA, USA. $^3$Alaska Fisheries Science Center, NOAA, Seattle, WA, USA. $^4$Alaska Fisheries Science Center, NOAA, Juneau, AK, USA
format: 
  revealjs:
    theme: simple
...
A4 [label =  'Use CAAL \n - More informative \n - Prioritize survey data \n - Length-stratified sampling', fillcolor = Beige]
